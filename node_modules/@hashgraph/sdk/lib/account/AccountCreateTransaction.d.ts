...
export default class AccountCreateTransaction extends Transaction {
    ...
    constructor(props?: {
        ...
        aliasKey?: import("../PublicKey.js").default | undefined;
        aliasEvmAddress?: EvmAddress | undefined;
    } | undefined);
    /**
     * @private
     * @type {?Key}
     ...
     * @returns {?PublicKey}
     */
    get aliasKey(): import("../PublicKey.js").default | null;
    /**
     * @param {PublicKey} aliasKey
     * @returns {this}
     */
    setAliasKey(aliasKey: PublicKey): this;
    /**
     * @returns {?EvmAddress}
     */
    get aliasEvmAddress(): EvmAddress | null;
    /**
     * @param {Uint8Array | string | EvmAddress} aliasEvmAddress
     * @returns {this}
     */
    setAliasEvmAddress(aliasEvmAddress: Uint8Array | string | EvmAddress): this;
    /**
     * @override
     * @protected
